radioConfig = {
    ...
    Frequency = {
        Private = { -- List of private frequencies
            ...
            [8] = true, -- Make 1 a private frequency
            [9] = true, -- Make 1 a private frequency
            [10] = true, -- Make 1 a private frequency
            [11] = true, -- Make 1 a private frequency
            [12] = true, -- Make 1 a private frequency
            [13] = true, -- Make 1 a private frequency
            [14] = true, -- Make 1 a private frequency
            [15] = true, -- Make 1 a private frequency
