...
function getPhoneRandomNumber()
    ...
    if xPlayer ~= nil then
    MySQL.Async.fetchAll('SELECT sim_card FROM users WHERE identifier = @identifier', {
...
function getOrGeneratePhoneNumber (sourcePlayer, identifier, cb)
    ...
    -- Mode esx_cartesim --
    if myPhoneNumber == "(Insert Sim)" or myPhoneNumber == nil then
...
function addMessage(source, identifier, phone_number, message)
    ...
    local myPhone = getNumberPhone(xPlayer.identifier)
