...
local SettingsList = {
    LeftArrow = { Dictionary = "root_cause", Texture = "arrowleft", X = 378, Y = 3, Width = 30, Height = 30 },
    RightArrow = { Dictionary = "root_cause", Texture = "arrowright", X = 400, Y = 3, Width = 30, Height = 30 },
            ...
            if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
                ...
                if Enabled == true or Enabled == nil then
                    if Selected then
                        ...
                        RenderText(ListText, CurrentMenu.X + SettingsList.Text.X + 15 + CurrentMenu.WidthOffset - RightOffset, CurrentMenu.Y + SettingsList.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset + 5, 0, SettingsList.Text.Scale, MenuColour.Txt.R or 191, MenuColour.Txt.G or 204, MenuColour.Txt.B or 148, MenuColour.Txt.A or 255, 2)
                    else
                        RenderText(Label, CurrentMenu.X + FontPos[MenuFont.Txt].Txt.X + LeftBadgeOffset, CurrentMenu.Y + FontPos[MenuFont.Txt].Txt.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, MenuFont.Txt or 6, FontPos[MenuFont.Txt].Txt.Scale, MenuColour.Txt.R or 191, MenuColour.Txt.G or 204, MenuColour.Txt.B or 148, MenuColour.Txt.A or 255)
                        RenderText(ListText, CurrentMenu.X + SettingsList.Text.X + 15 + CurrentMenu.WidthOffset - RightOffset, CurrentMenu.Y + SettingsList.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset  + 5, 0, SettingsList.Text.Scale, MenuColour.Txt.R or 191, MenuColour.Txt.G or 204, MenuColour.Txt.B or 148, MenuColour.Txt.A or 255, 2)
                    end
