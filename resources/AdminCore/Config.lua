Staff = {
    ...
    PlyListIndex = 1,
    PlyActions = {
        {Name = "Donner un objet", Value = "GiveItem", Menu = "ItemsList2", Desc = "Liste des objets disponnible sur le serveur"},
        {Name = "Donner une arme", Value = "GiveWeapon", Menu = "WeaponList2", Desc = "Liste des armes disponnible sur le serveur"},
        {Name = "Donner de l'argent", Value = "GiveMoney", Desc = "A utiliser pour les remboursement uniquement"},
        {Name = "Setjob", Value = "SetJob", Menu = "JobsList2", Desc = "Liste des métiers disponnible sur le serveur"},
        {Name = "Setorg", Value = "SetOrg", Menu = "Jobs2List2", Desc = "Liste des organistation disponnible sur le serveur"},
        {Name = "Revive", Value = "Revive", Desc = "Permet de se revive, a ne pas utiliser en scène"},
        {Name = "Supprimer les armes", Value = "ClearLoadout", Desc = "Supprime toute les armes"},
        {Name = "Vider l'inventaire", Value = "ClearInventory", Desc = "Supprime toute les objets"},
    },
    PlyListActions = {
        {Name = "Informations", Value = "GetInfo", Menu = "PlyInfos"},
