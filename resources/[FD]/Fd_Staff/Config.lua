Staff = {
    UseFd_Logs = true,
    UseSetJob2 = true, -- A changer selon votre version d'esx
    UseSetOrg = false, -- A changer selon votre version d'esx
    Use_esxAmbulancejob = false, -- A changer selon votre base
